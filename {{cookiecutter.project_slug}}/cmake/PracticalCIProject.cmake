...
function(practci_add_cpp_module)
  ...
  set(MODULE_PUBLIC_INCLUDE_DIR ${PROJECT_PUBLIC_INCLUDE_DIR}/${PROJECT_PREFIX}/${MODULE_PREFIX})
  set(MODULE_PRIVATE_INCLUDE_DIR ${PROJECT_PRIVATE_INCLUDE_DIR}/${PROJECT_PREFIX}/${MODULE_PREFIX})
  ...
  list(TRANSFORM MODULE_INTERFACE_HEADERS PREPEND ${MODULE_PUBLIC_INCLUDE_DIR}/)
